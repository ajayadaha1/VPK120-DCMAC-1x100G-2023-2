...
proc create_hier_cell_dataflow_0 { parentCell nameHier } {
  ...
  connect_bd_net -net aclk8_0_1 [get_bd_pins axis_rxtx_clk] [get_bd_pins axi_mcdma_0/s_axi_aclk] [get_bd_pins axi_register_slice_0/aclk] [get_bd_pins axis_256to512width_conv/aclk] [get_bd_pins axis_512to256width_conv/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk]
  ...
  connect_bd_net -net s_axis_aresetn_0_1 [get_bd_pins axis_rx_rstn_i] [get_bd_pins axis_256to512width_conv/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn]
...
MSTRCLK 1,0,0,0 IS_CURRENT_QUAD 1}}} \
  ...
  connect_bd_net -net dcmac_0_core_rx_axis_tdata0 [get_bd_pins dcmac_0_core/rx_axis_tdata0] [get_bd_pins rx_axis_tdata0]
  connect_bd_net -net dcmac_0_core_rx_axis_tdata1 [get_bd_pins dcmac_0_core/rx_axis_tdata1] [get_bd_pins rx_axis_tdata1]
  connect_bd_net -net dcmac_0_core_rx_axis_tuser_ena0 [get_bd_pins dcmac_0_core/rx_axis_tuser_ena0] [get_bd_pins rx_axis_tuser_ena0]
  connect_bd_net -net dcmac_0_core_rx_axis_tuser_ena1 [get_bd_pins dcmac_0_core/rx_axis_tuser_ena1] [get_bd_pins rx_axis_tuser_ena1]
  connect_bd_net -net dcmac_0_core_rx_axis_tuser_eop0 [get_bd_pins dcmac_0_core/rx_axis_tuser_eop0] [get_bd_pins rx_axis_tuser_eop0]
  connect_bd_net -net dcmac_0_core_rx_axis_tuser_eop1 [get_bd_pins dcmac_0_core/rx_axis_tuser_eop1] [get_bd_pins rx_axis_tuser_eop1]
  connect_bd_net -net dcmac_0_core_rx_axis_tuser_err0 [get_bd_pins dcmac_0_core/rx_axis_tuser_err0] [get_bd_pins rx_axis_tuser_err0]
  connect_bd_net -net dcmac_0_core_rx_axis_tuser_err1 [get_bd_pins dcmac_0_core/rx_axis_tuser_err1] [get_bd_pins rx_axis_tuser_err1]
  connect_bd_net -net dcmac_0_core_rx_axis_tuser_mty0 [get_bd_pins dcmac_0_core/rx_axis_tuser_mty0] [get_bd_pins rx_axis_tuser_mty0]
  connect_bd_net -net dcmac_0_core_rx_axis_tuser_mty1 [get_bd_pins dcmac_0_core/rx_axis_tuser_mty1] [get_bd_pins rx_axis_tuser_mty1]
  connect_bd_net -net dcmac_0_core_rx_axis_tuser_sop0 [get_bd_pins dcmac_0_core/rx_axis_tuser_sop0] [get_bd_pins rx_axis_tuser_sop0]
  connect_bd_net -net dcmac_0_core_rx_axis_tuser_sop1 [get_bd_pins dcmac_0_core/rx_axis_tuser_sop1] [get_bd_pins rx_axis_tuser_sop1]
  connect_bd_net -net dcmac_0_core_rx_axis_tvalid_0 [get_bd_pins dcmac_0_core/rx_axis_tvalid_0] [get_bd_pins rx_axis_tvalid_0]
  connect_bd_net -net dcmac_0_core_tx_axis_tready_0 [get_bd_pins dcmac_0_core/tx_axis_tready_0] [get_bd_pins tx_axis_tready_0]
  ...
  connect_bd_net -net tx_axi_clk_1 [get_bd_pins tx_axi_clk] [get_bd_pins dcmac_0_core/rx_axi_clk] [get_bd_pins dcmac_0_core/tx_axi_clk]
  connect_bd_net -net tx_axis_tdata0_1 [get_bd_pins tx_axis_tdata0] [get_bd_pins dcmac_0_core/tx_axis_tdata0]
  connect_bd_net -net tx_axis_tdata1_1 [get_bd_pins tx_axis_tdata1] [get_bd_pins dcmac_0_core/tx_axis_tdata1]
  connect_bd_net -net tx_axis_tuser_ena0_1 [get_bd_pins tx_axis_tuser_ena0] [get_bd_pins dcmac_0_core/tx_axis_tuser_ena0]
  connect_bd_net -net tx_axis_tuser_ena1_1 [get_bd_pins tx_axis_tuser_ena1] [get_bd_pins dcmac_0_core/tx_axis_tuser_ena1]
  connect_bd_net -net tx_axis_tuser_eop0_1 [get_bd_pins tx_axis_tuser_eop0] [get_bd_pins dcmac_0_core/tx_axis_tuser_eop0]
  connect_bd_net -net tx_axis_tuser_eop1_1 [get_bd_pins tx_axis_tuser_eop1] [get_bd_pins dcmac_0_core/tx_axis_tuser_eop1]
  connect_bd_net -net tx_axis_tuser_err0_1 [get_bd_pins tx_axis_tuser_err0] [get_bd_pins dcmac_0_core/tx_axis_tuser_err0]
  connect_bd_net -net tx_axis_tuser_err1_1 [get_bd_pins tx_axis_tuser_err1] [get_bd_pins dcmac_0_core/tx_axis_tuser_err1]
  connect_bd_net -net tx_axis_tuser_mty0_1 [get_bd_pins tx_axis_tuser_mty0] [get_bd_pins dcmac_0_core/tx_axis_tuser_mty0]
  connect_bd_net -net tx_axis_tuser_mty1_1 [get_bd_pins tx_axis_tuser_mty1] [get_bd_pins dcmac_0_core/tx_axis_tuser_mty1]
  connect_bd_net -net tx_axis_tuser_sop0_1 [get_bd_pins tx_axis_tuser_sop0] [get_bd_pins dcmac_0_core/tx_axis_tuser_sop0]
  connect_bd_net -net tx_axis_tuser_sop1_1 [get_bd_pins tx_axis_tuser_sop1] [get_bd_pins dcmac_0_core/tx_axis_tuser_sop1]
...
{PMC_MIO 26 .. 36}}} \
 ...
 ] [get_bd_intf_pins /axis_seg_and_unseg_c_0/m_axis0_pkt_out]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {391000600} \
 ] [get_bd_intf_pins /axis_seg_and_unseg_c_0/s_axis0]
  ...
  connect_bd_net -net axis_seg_and_unseg_c_0_Unseg2SegDat0_out [get_bd_pins axis_seg_and_unseg_c_0/Unseg2SegDat0_out] [get_bd_pins dcmac_and_gt/tx_axis_tdata0]
  connect_bd_net -net axis_seg_and_unseg_c_0_Unseg2SegDat1_out [get_bd_pins axis_seg_and_unseg_c_0/Unseg2SegDat1_out] [get_bd_pins dcmac_and_gt/tx_axis_tdata1]
  connect_bd_net -net axis_seg_and_unseg_c_0_Unseg2SegEop0_out [get_bd_pins axis_seg_and_unseg_c_0/Unseg2SegEop0_out] [get_bd_pins dcmac_and_gt/tx_axis_tuser_eop0]
  connect_bd_net -net axis_seg_and_unseg_c_0_Unseg2SegEop1_out [get_bd_pins axis_seg_and_unseg_c_0/Unseg2SegEop1_out] [get_bd_pins dcmac_and_gt/tx_axis_tuser_eop1]
  connect_bd_net -net axis_seg_and_unseg_c_0_Unseg2SegErr0_out [get_bd_pins axis_seg_and_unseg_c_0/Unseg2SegErr0_out] [get_bd_pins dcmac_and_gt/tx_axis_tuser_err0]
  connect_bd_net -net axis_seg_and_unseg_c_0_Unseg2SegErr1_out [get_bd_pins axis_seg_and_unseg_c_0/Unseg2SegErr1_out] [get_bd_pins dcmac_and_gt/tx_axis_tuser_err1]
  connect_bd_net -net axis_seg_and_unseg_c_0_Unseg2SegMty0_out [get_bd_pins axis_seg_and_unseg_c_0/Unseg2SegMty0_out] [get_bd_pins dcmac_and_gt/tx_axis_tuser_mty0]
  connect_bd_net -net axis_seg_and_unseg_c_0_Unseg2SegMty1_out [get_bd_pins axis_seg_and_unseg_c_0/Unseg2SegMty1_out] [get_bd_pins dcmac_and_gt/tx_axis_tuser_mty1]
  connect_bd_net -net axis_seg_and_unseg_c_0_Unseg2SegSop0_out [get_bd_pins axis_seg_and_unseg_c_0/Unseg2SegSop0_out] [get_bd_pins dcmac_and_gt/tx_axis_tuser_sop0]
  connect_bd_net -net axis_seg_and_unseg_c_0_Unseg2SegSop1_out [get_bd_pins axis_seg_and_unseg_c_0/Unseg2SegSop1_out] [get_bd_pins dcmac_and_gt/tx_axis_tuser_sop1]
  connect_bd_net -net axis_seg_and_unseg_c_0_Unseg2SegVal0_out [get_bd_pins axis_seg_and_unseg_c_0/Unseg2SegVal0_out] [get_bd_pins dcmac_and_gt/tx_axis_tuser_ena0]
  connect_bd_net -net axis_seg_and_unseg_c_0_Unseg2SegVal1_out [get_bd_pins axis_seg_and_unseg_c_0/Unseg2SegVal1_out] [get_bd_pins dcmac_and_gt/tx_axis_tuser_ena1]
  ...
  connect_bd_net -net clk_clk_out2 [get_bd_pins clk/clk_out2] [get_bd_pins dcmac_and_gt/tx_axi_clk] [get_bd_pins dataflow_0/axis_rxtx_clk] [get_bd_pins axi_noc_0/aclk8] [get_bd_pins rst_clk_wizard_0_782M/slowest_sync_clk] [get_bd_pins axis_seg_and_unseg_c_0/aclk_axis_unseg_in] [get_bd_pins axis_seg_and_unseg_c_0/aclk_rx_seg_in] [get_bd_pins axis_seg_and_unseg_c_0/aclk_tx_seg_in]
  ...
  connect_bd_net -net dcmac_and_gt_rx_axis_tdata0 [get_bd_pins dcmac_and_gt/rx_axis_tdata0] [get_bd_pins axis_seg_and_unseg_c_0/Seg2UnSegDat0_in]
  connect_bd_net -net dcmac_and_gt_rx_axis_tdata1 [get_bd_pins dcmac_and_gt/rx_axis_tdata1] [get_bd_pins axis_seg_and_unseg_c_0/Seg2UnSegDat1_in]
  connect_bd_net -net dcmac_and_gt_rx_axis_tuser_ena0 [get_bd_pins dcmac_and_gt/rx_axis_tuser_ena0] [get_bd_pins axis_seg_and_unseg_c_0/Seg2UnSegVal0_in]
  connect_bd_net -net dcmac_and_gt_rx_axis_tuser_ena1 [get_bd_pins dcmac_and_gt/rx_axis_tuser_ena1] [get_bd_pins axis_seg_and_unseg_c_0/Seg2UnSegVal1_in]
  connect_bd_net -net dcmac_and_gt_rx_axis_tuser_eop0 [get_bd_pins dcmac_and_gt/rx_axis_tuser_eop0] [get_bd_pins axis_seg_and_unseg_c_0/Seg2UnSegEop0_in]
  connect_bd_net -net dcmac_and_gt_rx_axis_tuser_eop1 [get_bd_pins dcmac_and_gt/rx_axis_tuser_eop1] [get_bd_pins axis_seg_and_unseg_c_0/Seg2UnSegEop1_in]
  connect_bd_net -net dcmac_and_gt_rx_axis_tuser_err0 [get_bd_pins dcmac_and_gt/rx_axis_tuser_err0] [get_bd_pins axis_seg_and_unseg_c_0/Seg2UnSegErr0_in]
  connect_bd_net -net dcmac_and_gt_rx_axis_tuser_err1 [get_bd_pins dcmac_and_gt/rx_axis_tuser_err1] [get_bd_pins axis_seg_and_unseg_c_0/Seg2UnSegErr1_in]
  connect_bd_net -net dcmac_and_gt_rx_axis_tuser_mty0 [get_bd_pins dcmac_and_gt/rx_axis_tuser_mty0] [get_bd_pins axis_seg_and_unseg_c_0/Seg2UnSegMty0_in]
  connect_bd_net -net dcmac_and_gt_rx_axis_tuser_mty1 [get_bd_pins dcmac_and_gt/rx_axis_tuser_mty1] [get_bd_pins axis_seg_and_unseg_c_0/Seg2UnSegMty1_in]
  connect_bd_net -net dcmac_and_gt_rx_axis_tuser_sop0 [get_bd_pins dcmac_and_gt/rx_axis_tuser_sop0] [get_bd_pins axis_seg_and_unseg_c_0/Seg2UnSegSop0_in]
  connect_bd_net -net dcmac_and_gt_rx_axis_tuser_sop1 [get_bd_pins dcmac_and_gt/rx_axis_tuser_sop1] [get_bd_pins axis_seg_and_unseg_c_0/Seg2UnSegSop1_in]
  connect_bd_net -net dcmac_and_gt_rx_axis_tvalid_0 [get_bd_pins dcmac_and_gt/rx_axis_tvalid_0] [get_bd_pins axis_seg_and_unseg_c_0/rx_axis_tvalid_i]
  connect_bd_net -net dcmac_and_gt_tx_axis_tready_0 [get_bd_pins dcmac_and_gt/tx_axis_tready_0] [get_bd_pins axis_seg_and_unseg_c_0/tx_axis_tready_i]
  ...
  connect_bd_net -net rst_clk_wizard_0_782M_peripheral_aresetn [get_bd_pins rst_clk_wizard_0_782M/peripheral_aresetn] [get_bd_pins dcmac_and_gt/s_axi_aresetn] [get_bd_pins dataflow_0/axis_rx_rstn_i] [get_bd_pins dataflow_0/axis_tx_rstn_i] [get_bd_pins axis_seg_and_unseg_c_0/aresetn_axis_unseg_in] [get_bd_pins axis_seg_and_unseg_c_0/aresetn_rx_seg_in] [get_bd_pins axis_seg_and_unseg_c_0/aresetn_tx_seg_in]
